...
func NewControllerUser(storage *storage.Storage, session sessions.Store, logger *logrus.Logger, sender *mail.Sender) *ControllerAdmin {
...
func (ctrl *ControllerAdmin) UpdateUser() http.HandlerFunc {
	type Request struct {
...
func (ctrl *ControllerAdmin) DeleteUser() http.HandlerFunc {
	type Request struct {
		Email string `json:"email"`
	}
	return func(w http.ResponseWriter, r *http.Request) {
...
func (ctrl *ControllerAdmin) FindUser() http.HandlerFunc {
	type Request struct {
		Email string `json:"email"`
	}
	return func(w http.ResponseWriter, r *http.Request) {
...
func (ctrl *ControllerAdmin) SendMessageAdmin() http.HandlerFunc {
	type Request struct {
		Msg string `json:"msg"`
	}
	return func(w http.ResponseWriter, r *http.Request) {
...
func (ctrl *ControllerAdmin) AdminLoginPage() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func (ctrl *ControllerAdmin) AdminLogin() http.HandlerFunc {
	type Request struct {
		Email    string `json:"email"`
...
func (ctrl *ControllerAdmin) AdminRegister() http.HandlerFunc {
	type Request struct {
		Email    string `json:"email"`
